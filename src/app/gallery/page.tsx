          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 auto-rows-[200px]">
            {galleryImages.map((img, i) => {
              ...
              return (
                <div
                  key={i}
                  className={`relative overflow-hidden rounded-2xl group ring-4 ${ringClass} hover:ring-offset-4 hover:ring-offset-yellow/10 transition-all duration-300 ${img.span} ${img.tall ? 'row-span-2' : ''}`}
                >
                  <Image
